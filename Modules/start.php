<?php
/**
 * This script handles the display of a site and its buttons and modules based on user permissions.
 * It includes a connection to the database and session handling.
 * The information from the database includes the buttons and modules needed to view the site with the given ID
 * The necessary permissions for the site and its buttons and modules are checked before they are displayed.
 * This page is the base for all sites.
 */
...
?>
  ...
  <?php
  //Include all moudles needed for this site
