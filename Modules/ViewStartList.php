...
?>
       ...
       <tr class="<?php if($execDisInfo != false && $execDisInfo['currentAthlete'] == $startRow['id']) { echo 'table-success text-dark'; } ?>">
        <td style="opacity:1">
        <?php  if($execDisInfo != false && $execDisInfo['currentAthlete'] == $startRow['id'])
{
