...
/**
 * This module helper script helps listing members with the selected filter criteria
 */
...
<form class="memberIdForm" name="memberIdForm" action="javascript:void(0);">
    ...
    WHERE environmentId LIKE ? $in");
        ...
        ?>
            <td>
                <input onchange="MANAGEMEMEBERScheckCheckedBoxes(this)" type="checkbox" class="memberCheckbox" name="memberIdSelected[]" value="<?php echo $memberRow['id']; ?>"></input>
            </td>
            <?php
